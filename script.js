...
labelBalance.addEventListener('click', function () {
  [...document.querySelectorAll('.movements__row')].forEach(function (row, i) {
    if (i % 2 === 0) row.style.backgroundColor = 'orangered'; // 0, 2, 4...
    if (i % 3 === 0) row.style.backgroundColor = 'blue'; // 0, 3, 6...
  });
});
*/
...
// Bigest number which JS can represent
console.log(2 ** 53 - 1);
...
console.log(7238947509283475628973456237894652387465873245692378456238745n);
console.log(BigInt(723894750928));

// Operations
console.log(10000n + 10000n);
console.log(23452345234552234523452n * 10000000n);
// console.log(Math.sqrt(16n));

const huge = 625384856n;
const num = 23;
...
console.log(new Date('Feb 21 2026 09:34:05'));
